...
from TargetSitePoint import TargetSitePoint
from HitPoint import HitPoint


def remove_unuse_contours(contours: list) -> list:
    # 小さな輪郭は削除する
    new_contours = []
...
# 小さい輪郭を削除して文字を消す
contours = remove_unuse_contours(contours)
...
targetSite: TargetSitePoint = TargetSitePoint(site_id=0, contours=contours)
targetSite.hit_point_list = pt_list

targetSite.print_point_list()
